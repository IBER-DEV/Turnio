...
# La comisión ya no se calcula desde acá. Vive en
# `apps.caja.services.comision_de_item`, sobre el `porcentaje_comision`
# **congelado** en la línea de venta y no sobre el del catálogo, que puede
# haber cambiado desde entonces (rediseño del módulo de dinero,
# 2026-08-07). Sus tests están en `apps/caja/tests/test_services.py`.
